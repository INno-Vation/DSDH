...
class Box2BoxTransform(object):
    ...
    def apply_deltas(self, deltas, boxes, weights = torch.tensor([1, 1, 1, 1])):
        """
        ...
        wx, wy, ww, wh = self.weights
        _wx, _wy, _ww, _wh = weights[0], weights[1], weights[2], weights[3]

        dx = deltas[:, 0::4] / wx * _wx
        dy = deltas[:, 1::4] / wy * _wy
        dw = deltas[:, 2::4] / ww * _ww
        dh = deltas[:, 3::4] / wh * _wh
